...
int[][] myExcel = {{10,27},{87,99,100},{90,100}};
      // tell me how to print 100 and 90 from this array
        ...
        // how many charactrers in the whole array?
        System.out.println(myExcel.length);
        System.out.println(Arrays.toString(myExcel[0]));
        System.out.println(myExcel[0].length); // the length of first 1D array
        System.out.println(myExcel[1].length); // the lenght of second 2D array
        System.out.println(myExcel[2].length);

        for (int i = 0; i < myExcel.length ; i++) {
            System.out.println("Item Number of index "+ i + " lenght is: "+ myExcel[i].length);
