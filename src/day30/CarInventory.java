...
//
//        }
//        System.out.println("Chevrolet " + countChev);
//        System.out.println("Civic "+ countCivic);
        //=========== FOR EACH METHOD============
        ...
        for (int x = 0; x < cars.length ; x++) {
            if(cars[x].contains("Civic")){
                System.out.println("Civic location: "+x);
            }
...
//                            " Car Model is " + eachCarSplitted[1]   );
       ...
       //For Each loop
        for (String eachCar : cars) { //i would create for each loop
            // we want to do this action only for one type of car brand
            // so we used start with method to check car brand
            if (eachCar.startsWith("Honda")) { // If statement for honda cars
                // we used split method to separate brand and model
                String[] eachCarSplitted = eachCar.split("-"); // Hohndy split from dashes
                // first part is brand , second part is model
                System.out.println("Car make is " + eachCarSplitted[0] + // Car input hodnd with model
                        " Car Model is " + eachCarSplitted[1]);
        ...
        for (int i = 0; i <cars.length ; i++) {
            String[] carSplitted = cars[i].split("-");
